...
class Loc_Maintenance(models.Model):
    loc_main_id = models.IntegerField(primary_key=True)
    locker = models.ForeignKey(Locker, on_delete=models.CASCADE)

class Maintenance_Type(models.Model):
    main_type_id = models.IntegerField(primary_key=True)
...
class Maintenance(models.Model):
    ...
    main_type = models.ForeignKey(Maintenance_Type, on_delete=models.CASCADE)
...
class Cust_Status_Type(models.Model):
    cust_stat_type_id = models.IntegerField(primary_key=True)
...
class Cust_Status(models.Model):
    cust_status_id = models.IntegerField(primary_key=True)
...
class Cust_Loc(models.Model):
    cust_loc_id = models.IntegerField(primary_key=True)
    cust_id = models.ForeignKey(Customer, on_delete=models.CASCADE)
...
class Event_Status(models.Model):
    event_status_id = models.IntegerField(primary_key=True)
...
class Cust_Loc_Event(models.Model):
    cust_loc_event_id = models.IntegerField(primary_key=True)
